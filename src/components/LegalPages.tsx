  ...
  return (
    <LegalPageWrapper title="Terms of Service" setView={setView}>
      <div>
        ...
        <p>By accessing or using the services provided by Real Luxe Studios ("Company," "we," "us," or "our"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.</p>
      </div>

      <div>
        <h2 className="text-xl font-semibold text-white mb-3">2. Services</h2>
        <p>Real Luxe Studios provides professional photography, videography, drone aerial media, 3D virtual tours, and related media production services for real estate, commercial, and residential properties. Service details, deliverables, and timelines are outlined in the selected package at the time of booking.</p>
      </div>
      ...
      <div>
        ...
        <p>Edited media will be delivered electronically within the timeframe specified for the selected package, typically within 24–48 hours. Rush delivery may be available for an additional fee. All deliverables remain the intellectual property of Real Luxe Studios until full payment is received.</p>
      </div>

      <div>
        <h2 className="text-xl font-semibold text-white mb-3">6. Usage Rights</h2>
        <p>Upon full payment, clients receive a non-exclusive, perpetual license to use the delivered media for marketing and promotional purposes related to the photographed property. Real Luxe Studios retains the right to use all media for portfolio, marketing, and promotional purposes unless otherwise agreed in writing.</p>
      </div>

      <div>
        <h2 className="text-xl font-semibold text-white mb-3">7. Limitation of Liability</h2>
        <p>Real Luxe Studios shall not be liable for any indirect, incidental, or consequential damages arising from the use of our services. Our total liability shall not exceed the amount paid for the specific service in question. We are not responsible for delays caused by weather, property access issues, or other circumstances beyond our control.</p>
      </div>
      ...
      <div>
        ...
        <p>If you have questions about these Terms of Service, please contact us at <a href="mailto:Thomas@realluxestudios.com" className="text-[#cbb26a] hover:underline">Thomas@realluxestudios.com</a>.</p>
      </div>
    </LegalPageWrapper>
  );
}
  ...
  return (
    <LegalPageWrapper title="Privacy Policy" setView={setView}>
      ...
      <div>
        ...
        <p>You have the right to access, correct, or delete your personal information. You may also request a copy of the data we hold about you. To exercise these rights, please contact us at <a href="mailto:Thomas@realluxestudios.com" className="text-[#cbb26a] hover:underline">Thomas@realluxestudios.com</a>.</p>
      </div>
  ...
  return (
    <LegalPageWrapper title="Cancellation Policy" setView={setView}>
      ...
      <div>
        ...
        <p>Eligible refunds will be processed to the original payment method within 5–10 business days. If you have questions about a refund or need to cancel a booking, please contact us as soon as possible at <a href="mailto:Thomas@realluxestudios.com" className="text-[#cbb26a] hover:underline">Thomas@realluxestudios.com</a>.</p>
      </div>
      ...
      <div>
        ...
        <p>For all cancellation and rescheduling requests, please email <a href="mailto:Thomas@realluxestudios.com" className="text-[#cbb26a] hover:underline">Thomas@realluxestudios.com</a> or call us at the number listed on our contact page.</p>
      </div>
    </LegalPageWrapper>
  );
}
